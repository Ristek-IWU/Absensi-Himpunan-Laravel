...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8">
        ...
        <h1 class="text-3xl font-bold text-gray-900">Tambah Data Pengurus</h1>
            <p class="mt-2 text-sm text-gray-700">Masukkan informasi pengurus baru HIMA IF</p>
    </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <input type="text" 
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500">Ketik ulang password</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-sm rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="sm:col-span-2">
                    ...
                    {{-- No current photo preview on create form --}}
                    <input type="file" 
                           name="foto" 
                           id="foto" 
                           accept="image/*"
